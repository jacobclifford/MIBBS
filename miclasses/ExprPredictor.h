...
double mutualinformatio3( const vector< Motif >& motifs, double alphadc );
...
double mutualinformatio9( const vector< Motif >& _motifs ,double alphadc );
...
void scorematrixscan( Matrix e , string& file, double maxLLR, string& file2 ); // e is LLRmat, file contains sequences LLRmat acts on, maxllr is maxLLR, file2 is output energies.// scans a crm or enhancer thereby allowing crms for negatives
void scorematrixscanoverlap( Matrix e , string& file, double maxLLR, string& file2 );  // allows overlapping sites,one strand, for crms
void scorematrixscanoverlapboth( Matrix e , string& file, double maxLLR, string& file2 );  // allows overlapping sites,both strands, for crms 
...
Site siteMaxscan( vector< Site >& sitess);   // used in negative data set for enhancers in scorematrixscan()
