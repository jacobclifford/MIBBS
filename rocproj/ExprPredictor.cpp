...
double Motif::PvalueSumdc9( double alpha ) 
{
int l = pwm.nRows();
vector< double > freqs;
vector< double > eners;
...
double Motif::PvalueSumdu9( double alpha ) 
{
int l = pwm.nRows();
vector< double > freqs;
vector< double > eners;
...
double Motif::PvalueSumcb9( double alpha ) 
{
int l = pwm.nRows();
vector< double > freqs;
vector< double > eners;
...
void Motif::countmatrix39( string& file, string& file2, string& file3  )
{
int l = pwm.nRows();
vector< double > freqs;
...
index = int( maxLLR-enerf8);
bins[index].push_back( pvalf8 );
enersa.push_back( maxLLR - enerf8 );  
